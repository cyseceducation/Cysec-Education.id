...
const socialLinks = [
  { label: "GitHub", href: site.social.github, path: socialPaths.github },
  { label: "Instagram", href: site.social.instagram, path: socialPaths.instagram },
  { label: "TikTok", href: site.social.tiktok, path: socialPaths.tiktok },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <img src="/logo-cysec-sm.png" alt="CYSEC Logo" className="h-10 w-10 object-contain" width={40} height={40} />
            ...
            <div className="flex items-center gap-4 pt-4">
              {socialLinks.map((s)=>(
                <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" aria-label={s.label} title={s.label} className="w-10 h-10 rounded-lg bg-gray-900 border border-gray-800 flex items-center justify-center text-gray-400 hover:text-[#00f3ff] hover:border-[#00f3ff]/50 hover:shadow-[0_0_15px_rgba(0,243,255,0.2)] transition-all duration-300">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-gray-400"><Mail className="w-5 h-5 text-[#00f3ff] flex-shrink-0"/><span>{site.email}</span></li>
